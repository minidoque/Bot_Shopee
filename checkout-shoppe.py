...
product_name = "POLICE-Kemeja-Regular-Fit-Pria-621060774-Biru-i.56529142.6052840877"
...
class CheckOutBot(PrepareBot):
    ...
    def getProduct(self):
        ...
        time.sleep(5)
        make_order = self.driver.find_element_by_xpath(
            '//*[@id="main"]/div/div[2]/div[3]/div[4]/div[2]/div[12]/button'
            ).click()   
...
# //*[@id="main"]/div/div[2]/div[3]/div[4]/div[2]/div[9]/button
